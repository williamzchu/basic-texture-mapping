...
* user_commands.js, readText.js, skybox.js, render_teapot.js, teapot_obj.js, gl-matrix-min.js, and webgl-utils.js.
*/
...
function setupCubeMap() {
	...
	var map_root = "skybox/";
	var cube_links = ["pos-x.png", "neg-x.png", "pos-y.png", "neg-y.png", "pos-z.png", "neg-z.png"];
	...
	for (let i = 0; i < 6; i++){
		...
		image.src = map_root + cube_links[i];
